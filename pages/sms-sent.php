                ...
                <div class="chat-body clearfix">
                    <div class="header">
                        ...
                        <small class="pull-right text-muted small">
                            <i class="fa fa-clock-o fa-fw"></i> <?php echo $sms['sent_time'];?>
                        </small>
                    </div>
                    <p>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"><?php echo $page_name; ?> 
                        <small>Pesan Terkirim (Sentbox)</small>
                    </h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-database fa-fw"></i> Daftar SMS Terkirim
...
$(document).ready(function(){    
    ...
    $('#data-count')
        ...
        .change(function(){
            sms_limit = $(this).val();
            setCookie('sms_limit_sent',sms_limit,365);
    ...
    $('.data-nav').click(function(e){        
        ...
        // alert (sms_offset+"\n"+sms_limit+"\n"+sms_keyword+"\n"+sms_sortorder);
        setCookie('sms_offset_sent',sms_offset, 360);
        setCookie('sms_limit_sent',sms_limit, 360);
        setCookie('sms_sortorder_sent',sms_sortorder, 360);
        reloadData(sms_offset, sms_limit, sms_sortorder);     
        return false;
    });
});
