 ...
 * 
 */
$my_jallo_kategori = 'Inkubator bayi';
$my_jallo_keyword = 'JALLO';
$my_jallo_description = 'marah2';
$my_jallo_sms_format = 'jallo*keterangan';
$my_jallo_sms_sample = 'jallo*woi, saya jallo ma';
 ...
 */
function my_hook_jallo_register_callback_function($keyword)
{
 ...
 *  - Keyword: your keyword.
 */
function my_hook_jallo_unregister_callback_function($keyword)
{
 ...
 *  - Keyword: your keyword.
 */
function my_hook_jallo_activation_callback_function($keyword)
{
    // create your table here, etc., and...
...
/**
 * Register your keyword jallo and its hook function to database. 
...
keyword_hook_register(
    $my_jallo_keyword, 
    'my_hook_jallo_function', // hook function name.
    __FILE__, // current file.
    $my_jallo_description, 
    $my_jallo_sms_format, 
    $my_jallo_sms_sample,
    $my_jallo_kategori
);
